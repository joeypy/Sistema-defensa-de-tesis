...
<div class="container py-4">
    ...
    <div class="row mb-4">
        <div class="col-md-3 mb-4">
            <a href="/comprar_zapatos/src/compras/historial_compras.php" class="text-decoration-none">
        ...
        <div class="col-md-3 mb-4">
            <a href="/comprar_zapatos/src/productos/gestion_productos.php" class="text-decoration-none">
                <div class="stat-card card text-center h-100">
                    <div class="card-body py-4">
        ...
        <div class="col-md-3 mb-4">
            <a href="/comprar_zapatos/src/productos/bajo_stock.php" class="text-decoration-none">
                <div class="stat-card card text-center h-100">
                    <div class="card-body py-4">
        ...
        <div class="col-md-3 mb-4">
            <a href="/comprar_zapatos/src/clientes/gestion_clientes.php" class="text-decoration-none">
                <div class="stat-card card text-center h-100">
                    <div class="card-body py-4">
        ...
        <div class="col-md-6 mb-4">
            <div class="dashboard-section">
                ...
                <div class="card-body p-0">
                    ...
                    <a href="/comprar_zapatos/src/compras/historial_compras.php" class="btn btn-link d-block text-center py-3 text-decoration-none">
        ...
        <div class="col-md-6 mb-4">
            <div class="dashboard-section">
                ...
                <div class="card-body p-0">
                    ...
                    <a href="/comprar_zapatos/src/productos/bajo_stock.php" class="btn btn-link d-block text-center py-3 text-decoration-none">
